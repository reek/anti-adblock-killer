  ...
  rules : {
    ...
    prem_link : {
      ...
      onStart : function () {
        ...
        Aak.addBaitElement('div#aswift_2');
      }
    },
    cubeupload_com : {
    ...
    winandmac_com : {
	  // source: http://pastebin.com/ZMnX0hCG
      host : ['winandmac.com'],
      onAlways : function () {
	    // use AdBlock Notify inline
