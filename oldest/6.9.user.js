...
Rules = {
  ...
  disableAlert : {
    Host : ['drivearabia.com','putlocker.com','doatoolsita.altervista.org','sockshare.com','free-movie-home.com','pc.online143.com','pregen.net','kooora.com'],
    Inject : function () {
    ...
    Loaded : function () {
	  ...
	  var reMessage = /Il semblerait que vous utilisiez un bloqueur de publicité !/;
		...
		reId.test(insertedNode.id) &&
  	    ...
  	    // Remove Message
  	    console.info("AdUnBlock premium system killed !");
  	  ...
  	  // Top bar Message (Free)
  	    ...
  	    // Remove Message
  	    console.info("AdUnBlock free system killed !");
  	    removeElement(insertedNode);
  	  }
  	  ...
  	  var reImg = /data:image\/png;base64,iVBORw0KGgoAAAANSUhEUgAA|data:image\/gif;base64,R0lGODlhMwLKAPcAAAAAAIAAAACAAICAAAAA|filmovizija.com\/kodee.png|dbzog.de\/Bilder\/dbzogb1.png/;
  	    ...
  	    if (insertedNode.id &&
  	      ...
  	      // Disable versions 2
  	      if (reWords1.test(insertedNode.innerHTML) &&
  	        reWords2.test(insertedNode.innerHTML)) {
			
  	        // Remove
  	        console.info("Antiblock v2 system killed !");
  	        removeElement(insertedNode);
  	        //console.log(insertedNode);
  	      }
  	      // Disable versions 3
  	        ...
  	        // Remove
  	        console.info("Antiblock v3 system killed !");
  	        removeElement(insertedNode);
  	        //console.log(insertedNode);
  	      }
  	      // Alternative solution to disable all versions
  	        ...
  	        // Remove
  	        console.info("Antiblock system killed !");
  	        removeElement(insertedNode);
  	        //console.log(insertedNode);
  	      }
  	      //  Many false positive
