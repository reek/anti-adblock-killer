...
Rules = {
  ...
  tweaktown : {
    Host : ['tweaktown.com'],
    Inject : function () {
      GM_addStyle("#div-gpt-ad-1378071706813-0 { height: 3px !important; display: none !important; }");
    }
  },
  debrideurstream : {
  ...
  eventhubs : {
    Host : ['eventhubs.com'],
    // document.write('<div id="blahyblaci1">an adverstisment</div>');
    Inject : function () {
  ...
  gamespowerita : {
   ...
   dizimag : {
     ...
     Loaded : function () {
       ...
       dynVar = html.match(/[a-z]{2}[0-9]{6}x/)[0];
