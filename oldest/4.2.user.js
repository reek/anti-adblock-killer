...
var reAdBlock = /ad blocker|ad block|ad-block|adblocker|ad-blocker|adblock|bloqueur|bloqueador|Werbeblocker|adblockert|آدبلوك بلس/i;
var reDisable = /disable|désactivez|désactiver|desactivez|desactiver|desative|desactivar|desactive|desactiva|deaktiviere|disabilitare|απενεργοποίηση|запрещать|állítsd le/i;
var reAds = /pubs?|publicités?|publicites?|publicidades?|anuncios?|advertisements?|advertising|publicity|لمنع الاعلانات/i;
...
Rules = {
  ...
  picstwist : {
    Host : ['picstwist.com','pornblogy.com'],
    Inject : function () {
  ...
  /* Element */
  divIDtester : {
    Host : ['osoarcade.com','d3brid4y0u.info','fileice.net','filmovizija.com','nosteam.ro','openrunner.com','chine-informations.com','easybillets.com','spox.fr','yovoyages.com','tv3.co.nz'],
    Inject : function () {
      addElement('tester');
    }
  },
  ...
  kissanime : {
	...
	if(/kissanime.com\/Anime\/.+\/Episode-.*/i.test(location.href)) {
	  var video = document.querySelector('embed[flashvars*="googlevideo.com"]');
  ...
  AntiBlockOrg : {
    ...
    Inserted : function (e) {
      ...
      if (eventElement(e).id &&
        ...
        // Version 3.xx
        if (eventElement(e).firstChild.firstChild.nodeName == 'IMG' && eventElement(e).firstChild.firstChild.src.contains('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAA')) {
          removeElement(eventElement(e));
        }
        // Version 2.xx
  ...
  GM_xmlhttpRequest({
    ...
    onload : function (response) {
      ...
      if (Number(localVersion) < Number(remoteVersion)) {
        notifyUser.box('The version ' + remoteVersion + ' is now available | <a style="color: #fc0 !important;" href="' + downloadURL + '">Install</a>', 20000);
      } else {
