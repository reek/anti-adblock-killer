...
Rules = {
  ...
  kissanime : {
	...
	if(/kissanime.com\/Anime\/.+\/Episode-.*/i.test(location.href)) {
	  var video = document.querySelector('#divVideoJW embed[flashvars*="googlevideo.com"][id]');
 ...
 /*
   antennesport : {
    Host : ['antennesport.com'],
    Loaded : function () {

	  document.querySelector('#controle').submit();
